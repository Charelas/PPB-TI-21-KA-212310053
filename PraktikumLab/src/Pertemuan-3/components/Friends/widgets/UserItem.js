...
const UserItem = ({ item }) => {
  ...
  //Menyusun path gambar berdasarkan gender
  const imagePath = gender === 'M' ? require ('../../../../../assets/icons/icon-boy-1.png') : require ('../../../../../assets/icons/icon-girl-1.png')
  return (
    <View style={styles.search_container}>
      <View style={styles.search_account}>
        <Image source={item.image} style={styles.story_ava} />
        <View>
